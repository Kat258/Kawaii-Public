package dev.kizuna.mod.gui.clickgui;
...
public class ClickGuiScreen extends Screen implements Wrapper {
    ...
    public void render(DrawContext drawContext, int mouseX, int mouseY, float partialTicks) {
        ...
        Kawaii.GUI.draw(mouseX, mouseY, drawContext, partialTicks);
    }

    @Override
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        Kawaii.MODULE.modules.forEach(module -> module.getSettings().stream()
