...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(Kawaii.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = Kawaii.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = Kawaii.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
