...
public class AutoDupe extends Module {
            ...
            case Xin -> {
                ...
                switch (stage) {
                    ...
                    case Tame -> {
                        ...
                        if (mc.player.hasVehicle()) {
                            ...
                            if (llama.isBaby()) {
                                ...
                                InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                                Kawaii.ROTATION.lookAt(llama.getPos());
                    ...
                    case Kill -> {
                        ...
                        if (check()) {
                            Kawaii.ROTATION.lookAt(llama.getEyePos());
    ...
    private void closeTo(BlockPos pos) {
        ...
        float forward = 1f;
        float side = 0;
        float yaw = Kawaii.ROTATION.getRotation(pos.toCenterPos())[0];
