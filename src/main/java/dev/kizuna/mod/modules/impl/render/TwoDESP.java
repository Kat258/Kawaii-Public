...
public class TwoDESP extends Module {
    ...
    private final BooleanSetting outline = add(new BooleanSetting("Outline", true, () -> page.getValue() == Page.Setting));
    private final BooleanSetting renderHealth = add(new BooleanSetting("renderHealth", true, () -> page.getValue() == Page.Setting));
    private final BooleanSetting renderArmor = add(new BooleanSetting("Armor Dura", true, () -> page.getValue() == Page.Setting));
    private final SliderSetting durascale = add(new SliderSetting("DuraScale", 1, 0, 2, 0.1, () -> renderArmor.getValue()));


    private final BooleanSetting drawItem = add(new BooleanSetting("draw Item Name", true, () -> page.getValue() == Page.Setting));
    private final BooleanSetting drawItemC = add(new BooleanSetting("draw Item Count", true, () -> page.getValue() == Page.Setting && drawItem.getValue()));
    private final BooleanSetting font = add(new BooleanSetting("CustomFont", true, () -> page.getValue() == Page.Setting));
    ...
    private final ColorSetting playersC = add(new ColorSetting("PlayersBox", new Color(0xFF9200), () -> page.getValue() == Page.Color));
    private final ColorSetting friendsC = add(new ColorSetting("FriendsBox", new Color(0x30FF00), () -> page.getValue() == Page.Color));
    private final ColorSetting crystalsC = add(new ColorSetting("CrystalsBox", new Color(0x00BBFF), () -> page.getValue() == Page.Color));
    private final ColorSetting creaturesC = add(new ColorSetting("CreaturesBox", new Color(0xA0A4A6), () -> page.getValue() == Page.Color));
    private final ColorSetting monstersC = add(new ColorSetting("MonstersBox", new Color(0xFF0000), () -> page.getValue() == Page.Color));
    private final ColorSetting ambientsC = add(new ColorSetting("AmbientsBox", new Color(0x7B00FF), () -> page.getValue() == Page.Color));
    private final ColorSetting othersC = add(new ColorSetting("OthersBox", new Color(0xFF0062), () -> page.getValue() == Page.Color));
    public final ColorSetting armorDuraColor = add(new ColorSetting("Armor Dura Color", new Color(0x2fff00), () -> page.getValue() == Page.Color));
    public final ColorSetting textcolor = add(new ColorSetting("Item Name Color", new Color(255, 255, 255, 255), () -> page.getValue() == Page.Color && drawItem.getValue()));
    public final ColorSetting countColor = add(new ColorSetting("Item Count Color", new Color(255, 255, 0, 255), () -> page.getValue() == Page.Color && drawItemC.getValue()));
    public final ColorSetting hHealth = add(new ColorSetting("High Health Color", new Color(0,255,0,255), () -> page.getValue() == Page.Color));
    public final ColorSetting mHealth = add(new ColorSetting("Mid Health Color", new Color(255,255,0,255), () -> page.getValue() == Page.Color));
    public final ColorSetting lHealth = add(new ColorSetting("Low Health Color", new Color(255,0,0,255), () -> page.getValue() == Page.Color));
    ...
    public boolean shouldRender(Entity entity) {
        ...
        if (entity instanceof PlayerEntity) {
            ...
            if (Kawaii.FRIEND.isFriend((PlayerEntity) entity))
    ...
    public void drawText(Entity ent, DrawContext context) {
        ...
        if (position != null) {
            ...
            if (ent instanceof ItemEntity entity && drawItem.getValue()) {
                ...
                float textWidth = (FontRenderers.ui.getWidth(entity.getDisplayName().getString()) * 1);
