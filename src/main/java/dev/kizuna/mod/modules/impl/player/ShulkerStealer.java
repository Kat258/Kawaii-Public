...
public class ShulkerStealer extends Module {
    ...
    private final SliderSetting boots = add(new SliderSetting("Boots", 1, 0, 36, () -> take.getValue() && smart.isOpen()));
    private final SliderSetting elytra = add(new SliderSetting("Elytra", 1, 0, 36, () -> take.getValue() && smart.isOpen()));
    private final SliderSetting sword = add(new SliderSetting("Sword", 1, 0, 36, () -> take.getValue() && smart.isOpen()));
    private final SliderSetting pickaxe = add(new SliderSetting("Pickaxe", 1, 0, 36, () -> take.getValue() && smart.isOpen()));
    ...
    private final SliderSetting turtleMaster = add(new SliderSetting("Turtle_Master", 6, 0, 36, () -> take.getValue() && smart.isOpen()));
    private final SliderSetting gapple = add(new SliderSetting("Gapple", 128, 0, 512, () -> take.getValue() && smart.isOpen()));
    private final SliderSetting cfruit = add(new SliderSetting("Cfruit", 64, 0, 512, () -> take.getValue() && smart.isOpen()));
    private final SliderSetting endChest = add(new SliderSetting("EndChest", 64, 0, 512, () -> take.getValue() && smart.isOpen()));
