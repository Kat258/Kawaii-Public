...
import dev.kizuna.mod.modules.impl.combat.AutoCev;
	...
	public void onUpdate() {
		...
		if (waitPlace.getValue()) {
			for (Direction i : Direction.values()) {
				if (breakPos.offset(i).equals(KawaiiAura.crystalPos)) {
					if (KawaiiAura.INSTANCE.canPlaceCrystal(KawaiiAura.crystalPos, false, false)) {
						return;
					}
					break;
				}
