...
import dev.kizuna.api.events.impl.EntityVelocityUpdateEvent;
import dev.kizuna.api.events.impl.PacketEvent;
import dev.kizuna.api.utils.math.Timer;
import dev.kizuna.asm.accessors.IEntityVelocityUpdateS2CPacket;
import dev.kizuna.asm.accessors.IExplosionS2CPacket;
...
public class Velocity extends Module {
	...
	public void onVelocity(EntityVelocityUpdateEvent event) {
		...
		if (mode.is(Mode.Grim) || mode.is(Mode.Wall)) {
			...
			boolean insideBlock = Kawaii.PLAYER.insideBlock;
	...
	public void onUpdate() {
		...
		if (flag) {
			if (lagBackTimer.passed(100) && (flagInWall.getValue() || !Kawaii.PLAYER.insideBlock)) {
