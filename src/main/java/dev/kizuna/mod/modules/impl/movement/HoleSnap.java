...
public class HoleSnap extends Module {
    ...
    public final BooleanSetting blink = add(new BooleanSetting("Blink", false));
    public final BooleanSetting step = add(new BooleanSetting("Step", false));
    ...
    public void onEnable() {
        ...
        resetMove = false;
        holePos = Kawaii.HOLE.getHole((float) range.getValue(), true, any.getValue(), up.getValue());
    }
    ...
    public void onUpdate() {
        ...
        if (Kawaii.HOLE.isDoubleHole(holePos)) {
            Direction facing = Kawaii.HOLE.is3Block(holePos);
            if (facing != null) {
    ...
    public static void drawCircle(MatrixStack matrixStack, Color color, double circleSize, Vec3d pos, int segments) {
        ...
        for (double i = 0; i < 360; i += ((double) 360 / segments)) {
            ...
            bufferBuilder.vertex(matrix, (float) tempPos.x, (float) tempPos.y, (float) tempPos.z);
        }
