...
// TODO By ZeroSeven
public class DynamicIslandLegacy extends Module {
    public static DynamicIslandLegacy INSTANCE;
    ...
    public DynamicIslandLegacy() {
        super("DynamicIslandLegacy", Category.Client);
        setChinese("灵动岛");
        INSTANCE = this;
    }
    ...
    private void renderDefaultHUD(DrawContext context) {
        ...
        int x = animation.getXAnimation(mc.getWindow().getScaledWidth(), (int) width);
        int y = 15;
