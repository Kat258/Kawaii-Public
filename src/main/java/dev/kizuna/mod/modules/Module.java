...
public abstract class Module extends Mod {
	...
	private boolean listHide() {
		return this instanceof Colors || this instanceof AntiCheat || this instanceof ClientSetting || this instanceof ServerApply || this instanceof HUD || this instanceof Arraylist;
	}
	...
	private final List<Setting> settings = new java.util.ArrayList<>();
