...
import dev.kizuna.mod.modules.impl.client.Arraylist;
...
public class ConfigManager extends Manager {
	...
	public void loadSettings() {
		for (Module module : Kawaii.MODULE.modules) {
			...
			module.setState(Kawaii.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof Arraylist));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + Kawaii.PREFIX);
			...
			System.out.println("[" + Kawaii.NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + Kawaii.NAME + "] Failed to load settings");
		}
	}
